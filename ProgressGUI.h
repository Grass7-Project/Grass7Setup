...
public:
	...
	static void createProgressText(HDC &hdc, int &percent1, int &percent2, int &percent3, int &percent4, std::wstring &Text1, std::wstring &Text2, std::wstring &Text3, std::wstring &Text4, BOOL &ValuesInit);
	...
	static void WaitThread(BOOL &WaitThreadRunning, BOOL &WaitThreadExit, int &Percentage, std::wstring &Text, int xPos, int yPos, std::wstring &Dots);
};